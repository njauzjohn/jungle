...
const EditProduct = ({close, data : propsData, fetchProductData}) => {
  ...
  return (
    <section className=' top-0 right-0 bottom-0 left-0 z-50 relative '>
      <div className='bg-slate-300 w-full max-w-2xl p-4 mx-auto rounded overflow-y-auto h-full max-h-[95vh] '>
              ...
              <div className='my-2 flex gap-1'>
                  {
                    data.image.map((img,index)=>{
                      return(
                        <div key={img+index+"editProduct"} className='h-32 w-32 min-w-20 bg-slate-200  relative group'>
                          <img
                ...
                <div className='flex flex-wrap gap-1'>
                    {
                      data.category.map((c,index)=>{
                        return(
                          <div key={c._id+index+"products"} className='text-sm flex items-center gap-1  bg-slate-300 shadow-md mt-2'>
                ...
                <div className='flex flex-wrap gap-1'>
                    {
                      data?.subcategory?.map((c,index)=>{
                        return(
                          <div key={c._id+index+"Subproducts"} className='text-sm flex items-center gap-1  bg-slate-300 shadow-md mt-2'>
