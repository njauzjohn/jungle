...
const ProductCardAdmin = ({data, fetchProductData}) => {
  ...
  return (
    <div className='w-42 p-4  bg-white rounded flex justify-between '>
      <div className='grid'>
        <img
            src={data?.image}
            alt={data?.name}
        ...
        <div>
            <p className='bg-slate-300 rounded-full px-2 text-ellipsis line-clamp-2 font-medium'>{data?.name}</p>
